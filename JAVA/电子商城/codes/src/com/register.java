...
public class register extends JInternalFrame {
	...
	private String regex="^[a-zA-Z0-9-]+$"; //正则表达式，表示由大小写字母和数字组成的字符串
	...
	public register() {
		...
		label_usrname.setBounds(35, 77, 61, 16);
		...
		label_password.setBounds(35, 145, 61, 16);
		...
		register_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					/*密码的重复输入匹配检验*/
						...
						insert_usr.Insert_usr(uname,pas);
