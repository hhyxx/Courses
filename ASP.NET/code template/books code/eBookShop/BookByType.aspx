...
<%@ Page language="c#" Inherits="eBookShop.BookByType" CodeFile="BookByType.aspx.cs" %>
...
<HTML>
	...
	<body>
		...
		<table cellSpacing="0" cellPadding="0" width="100%" border="0">
			<tr>
				<td style="WIDTH: 112px" vAlign="top" colSpan="0"><ebookshop:left id="BookCategory" runat="server"></ebookshop:left></td>
				<TD style="WIDTH: 566px" vAlign="top" width="100%"><asp:datalist id="dl_BookByType" runat="server" RepeatColumns="2" Width="560px" ShowHeader="False"
						ShowFooter="False" Height="294px">
						<ItemTemplate>
							<FONT face="宋体">
